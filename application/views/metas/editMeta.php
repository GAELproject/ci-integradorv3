                            ...
                            <div class="col-lg-10">
                                <?php foreach($bolsistasall as $bolsista){ ?>
                                    <?php foreach($usuario_tem_meta as $utm){?>
                                            <input type="checkbox" name="id_usuario[]" id="users" value="<?= $utm['usuario_id'];?>"
                                                <?php if($utm['usuario_id'] == $bolsista['id_usuario'] && $utm['meta_id'] == 
                                                $meta['id_meta']){echo "checked";}?>
                                            >
                                            <label for="">Nome: <?= $bolsista['u_nome'];?>
                                                CPF: <?=$bolsista['cpf']?> 
                                                Turno de atividades: <?= $bolsista['turno'];?></label>

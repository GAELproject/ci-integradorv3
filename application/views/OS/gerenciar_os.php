                  ...
                  <div class="form quick-post">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/OS/cadastrar/')?>">
                      ...
                      <div class="form-group">
                        <label class="control-label col-lg-9" for="content">Equipamento</label>
                        <div class="col-lg-10">
                      ...
                      <!-- Content -->
                       <!--turno-->
                       <div class="form-group">
                        <label class="control-label col-lg-9" for="content">Número da OS</label>
                        <div class="col-lg-10">
                      ...
                      <!--fim turno-->
                        ...
                        <div class="form-group">
                          <label class="control-label col-lg-9" for="prazo">CPF do cliente</label>
                          <div class="col-lg-10">
                          ...
                          <div class="form-group">
                          <label class="control-label col-lg-9" for="nomec">Nome do cliente</label>
                          <div class="col-lg-10">
                          ...
                          <div class="form-group">
                          <label class="control-label col-lg-9" for="num">Número do telefone do cliente</label>
                          <div class="col-lg-10">
                          ...
                          <div class="form-group">
                          <label class="control-label col-lg-9" for="cemail">E-mail do cliente</label>
                          <div class="col-lg-10">
